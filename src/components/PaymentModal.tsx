        ...
        >
          ...
          >
            ...
            <div className='p-6'>
              ...
              <button
                onClick={() => {
                  alert(`Pembayaran berhasil untuk nomor ${phoneNumber}!`)
                  onClose()
                }}
                disabled={!phoneNumber}
                className='w-full bg-brand-primary text-white py-3.5 rounded-lg font-bold hover:bg-[#00556b] transition-colors shadow-sm mb-4 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-brand-primary'
              >
                Bayar Sekarang
              </button>
