              ...
              <form onSubmit={handleSubmit} className='space-y-5'>
                ...
                <div className='space-y-2'>
                  ...
                  <input
                    ...
                    required
                    className='w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006780]/20 focus:border-[#006780] text-gray-900 text-sm transition-colors'
                  />
                </div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='relative'>
                    <input
                      ...
                      placeholder='••••••••'
                      required
                      className='w-full pl-4 pr-10 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006780]/20 focus:border-[#006780] text-gray-900 text-sm transition-colors tracking-widest placeholder:tracking-widest'
                    />
                    <button
                      type='button'
                ...
                <button
                  type='submit'
                  disabled={isLoading}
                  className='w-full bg-[#006780] text-white py-3.5 rounded-lg font-bold hover:bg-[#00556b] transition-colors shadow-sm mt-2 mb-2 inline-flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed'
                >
                  {isLoading ? (
                    <>
